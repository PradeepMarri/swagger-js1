# Swagger Client API MCP Server

This MCP (Model Content Protocol) server provides access to Swagger Client API API functionality through HTTP, HTTPS, and STDIO transport modes.
